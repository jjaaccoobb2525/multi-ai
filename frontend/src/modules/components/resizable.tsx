...
data-[panel-group-direction=vertical]:after:translate-x-0 dark:bg-neutral-800
dark:focus-visible:ring-neutral-300 [&[data-panel-group-direction=vertical]>div]:rotate-90`,
      className
    )}
    {...props}
  >
...
border-neutral-200 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-800"
      >
